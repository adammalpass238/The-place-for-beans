...
export default function NavBar() {
    const [menuOpen, setMenuOpen] = useState(false);
    //container = MenuOpen, function to update the container = setMenuOpen, current value of the container = false
    const [scrolled, setScrolled] = useState(false);
    ...
    return (
        <motion.header
            ...
            transition={{ duration: 0.5, ease: [0.25, 0.46, 0.94] }}>
            <div className="mx-auto flex w-full max-w-7xl items-center justify-between px-4 py-3 md:px-8">
                {/* BRAND */}

                <a href="#home" className="brand">
                    <img src={logo} alt="Beans place logo" className="h-12 w-auto md:h-14" />
                </a>
