...
const values = [
    {
        ...
        title:"Direct Trade Origins",
        discription: 
        "We partenr directly with small farms in Ethiopia, Colombia, Guatemala, and Indonesia. Every bag is fully traceable to the farm it came from"
    },
    {
        icon:"☕",
        title:"Small-Batch Roasting",
        discription: 
        "Our master roaster profiles every bean to unlock its peak flavor. We roast in 25lb batches for consistency and freashness you can taste."
    },
    {
        icon:"🚚",
        title:"Roast-To-Order Shipping",
        discription: 
        "We dont pre-roast and shelve. Your beans are roasted after you order and shipped within 1-2 days. Free delivery on orders over $50."
    },
];
      ...
      <div className="about-content">
        ...
        <ScrollReveal animation="fadeUp">
            <Badge variant="default" className="mb-4">
                Founded in 2012 | Roasting in-house since day one.
            </Badge>
        </ScrollReveal>
        ...
        <ScrollReveal anmimation="fadeIn" delay={0.2}>
        <Separator className="mb-8 max-w-64" />
        </ScrollReveal>
        
        {/* two column story wiht image */}
        <div className="about-story-grid">
            <ScrollReveal animation="fadeLeft" className="about-story-text">
                <p className="about-body lead--light">
                    The Beans Place started in 2012 with one simple belief; great coffee should be accessable to everyone...
                </p>
                <p className="about-body lead--light">
                    Every week, Our roastmaster cups dozens od samples to select only the lots that meet our standard. Whether you prefer a bright, fruity Ethiopian yirgacheffe or a deep, chocolatey Columbian Supremo, we roast each batch to order so it will arrive at its peak freshness.
                </p>
            </ScrollReveal>
            ...
            { values.map ( (v) => (
                ...
                <StaggerItem key={v.title} animation="fadeUp">
                    <Card glass className="about-value-card">
                        ...
                        <CardContent>
                            <p className="text-sm leading-relaxed text-white/70">{v.discription}</p>
                        </CardContent>
                    </Card>
                </StaggerItem>
